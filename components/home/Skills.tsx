...
function Skills() {
  return (
    <div id="skills" className="flex flex-col md:flex-row justify-between relative scroll-mt-20">
      <h2 className="relative text-3xl w-full text-center md:text-left font-bold md:max-w-lg mb-10 md:mr-10 md:mb-0 md:w-max mr-0 ">
        ...
        />
        <img
            className="sqD hidden sm:block left-[100px] lg:left-[160px] bottom-[-120px]"
            style={{ animationDelay: "0.5s" }}
            src="/static/doodles/hero/js.svg"
          />
        {/* <h2>
          Proficient in designing robust backend systems and responsive front-end interfaces.
          <br />  

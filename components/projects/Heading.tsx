    ...
    >
      ...
      {!tag && (
        <p className="text-fun-gray text-xl sm:text-2xl max-w-3xl m-auto">
          I've built powerful apps and websites using technologies from Django on the backend to Flutter for mobile and React/Next.js for the front end. Here are some of my favorite projects from my development journey.
        </p>
      )}
    </div>
  );
